/* 
7.Faça um programa em C que leia o valor da hora de trabalhoe o total de horas trabalhadas no mês e calcule o salário bruto, o salário líquido, e os impostos descontados. Considere IR igual a 25% e INSS igual a 11%
*/
...
int main(){
  ...
  printf("--------------------------------------\n");
  printf("Salario bruto...: R$ \x1b[34m%20.2f\x1b[0m\n", valor_salario_bruto);
  printf("Imposto Renda...: R$ \x1b[31m%20.2f\x1b[0m\n", valor_imposto_de_renda);
  printf("Imposto Previ...: R$ \x1b[31m%20.2f\x1b[0m\n", valor_imposto_previdencia);
  printf("Salario Liquido...: R$ \x1b[32m%18.2f\x1b[0m\n", valor_salario_liquido);
